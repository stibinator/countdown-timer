  ...
  function Start-CountdownTimer{
    ...
    .SYNOPSIS
    Displays a text-based countdown timer

    .DESCRIPTION
    Displays a timer counting down the seconds until the script terminates. Parameters control the length that it runs for.
